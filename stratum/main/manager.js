...
const Manager = function(config, configMain) {
  ...
  this.handleShare = function(jobId, client, submission) {
    ...
    const hashDigest = Algorithms.meraki.hash();
    ...
    const shareMultiplier = Algorithms.meraki.multiplier;
    const shareDiff = Algorithms.meraki.diff / Number(headerBigInt) * shareMultiplier;
    const blockDiffAdjusted = job.difficulty * Algorithms.meraki.multiplier;
